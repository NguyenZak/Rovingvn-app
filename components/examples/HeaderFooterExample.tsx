/**
 * Example: Sử dụng Logo và Metadata trong Header Component
 * File này là ví dụ minh họa, bạn có thể áp dụng vào các component thực tế
 */
            ...
            <nav className="container mx-auto px-4 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                        {/* Cách 1: Sử dụng Logo component với hình ảnh */}
                        <Logo
                            variant="main"
                            height={48}
                            priority
                        ...
                        {/* Cách 2: Sử dụng LogoText nếu chưa có logo */}
                        {/* <LogoText className="text-green-600" /> */}
                    </div>
                    ...
                    <ul className="hidden md:flex items-center gap-6">
                        ...
                        <li>
                            <Link href="/tours" className="hover:text-green-600 transition-colors">
                                Tours
                            </Link>
                        </li>
                        <li>
...
/**
 * Example: Footer với Logo và Social Links
 */
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        {/* Logo dark variant cho nền tối */}
                        <Logo
                            variant="dark"
                            height={48}
                            className="mb-4 filter brightness-200"
                        />
